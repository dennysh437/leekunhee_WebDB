...
const rows = [
  createData('BORBO01', '최ㅇ서', 'F', 15, '2022', 'SH527', '경기',
    [{ date: '<Variant1>', customerId: ' ', amount: ' ' },
      ...
      {date:<img src='Audio/SH527.jpg' width='395px'/>, customerId: <img src='Audio/SH527_2.png' width='395px'/>, amount:''}]),  
  createData('BORBO02', '김ㅇ림', 'F', 22, '2022', 'SH536', '서울',
    [{ date: '<Variant1>', customerId: ' ', amount: ' ' },
      ...
      { date: ' ', customerId: ' ', amount: ' ' },
      { date: '<Image>', customerId: ' ', amount: ' '},
      {date:<img src='Audio/SH536.jpg' width='395px'/>, customerId: <img src='Audio/SH536_2.png' width='395px'/>, amount:''}]),
